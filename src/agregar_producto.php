...
if (!empty($_POST)) {
    ...
    if (!empty($_POST['cantidad']) || !empty($_POST['precio']) || !empty($_POST['producto_id'])) {
        ...
        $producto_id = $_GET['id'];
        $total = $cantidad + $data_producto['CANTIDAD_PRODUCTO'];
        $query_insert = mysqli_query($conexion, "UPDATE productos SET CANTIDAD_PRODUCTO = $total WHERE ID_PRODUCTO = $id_producto");
        if ($query_insert) {
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo $data_producto['PRECIO_PRODUCTO']; ?>" disabled>
                    </div>
                    <div class="form-group">
                        <label for="precio">Cantidad de productos Disponibles</label>
                        <input type="number" class="form-control" value="<?php echo $data_producto['CANTIDAD_PRODUCTO']; ?>" disabled>
                    </div>
                    <div class="form-group">
                        <label for="precio">Nuevo Precio</label>
                        <input type="text" placeholder="Ingrese nombre del precio" name="precio" class="form-control" value="<?php echo $data_producto['PRECIO_PRODUCTO']; ?>">
                    </div>
                    <div class="form-group">
