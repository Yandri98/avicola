                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div>
                                ...
                                <label>Nombres</label>
                                <input type="text" name="nom_cliente" id="nom_cliente" class="form-control" placeholder="Ingrese nombres del cliente" required>
                            </div>
                        </div>
                       <div class="col-lg-4">
                            <div>
                                ...
                                <input type="text" name="apellidos" id="apellidos" class="form-control" placeholder="" disabled required>
                            </div>
                        </div> 
                        <div class="col-lg-4">
                            <div class="form-group">
